...
// 					<button className="modifyPwBtn" onClick={infoModifyHandler}>
// 								비밀번호 수정
// 					</button>
// 					</div>
// 				</div>
...
export default function UserInfo({ history, match, modalOff }) {
	...
	return (
		<>
			<div className="userInfoWrapper" onClick={modalOff}>
				<div className="userInfoText">{/* <UserPostLists userPostList={userListData} userTitleChecker={userTitleChecker}/> */}</div>
				<div className="infoChange">
					<span className="modi-line-or">
						<span className="modi-txt-or">회원 정보 수정</span>
					</span>
